 ...
 */
public class AutoIntentClassCreatorProxy extends BaseClassCreatorProxy {
     ...
     */
    public AutoIntentClassCreatorProxy(Elements elementUtils, TypeElement classElement) {
        super(elementUtils, classElement);
    }

    @Override
    protected String createBindingClassName(String className) {
        return className + "AutoIntent";
    }
